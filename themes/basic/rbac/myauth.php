...
$this->registerJsFile("@web/public/basic/js/custom/dashboard.js"); 
?>
...
<head>
    ...
    <!--[if lte IE 8]><script language="javascript" type="text/javascript" src="<?= Yii::getAlias('@basic') ?>/js/plugins/excanvas.min.js"></script><![endif]-->
    <!--[if IE 9]>
                                            ...
                                            <ul class="entrylist">
                                                  <li>
                                                    <div class="entry_wrap">
                                                        <div class="entry_img"><img src="<?= Yii::getAlias('@basic') ?>/images/thumbs/image1.png" alt="" /></div>
                                                  ...
                                                  <li class="even">
                                                    <div class="entry_wrap">
                                                    <div class="entry_img"><img src="<?= Yii::getAlias('@basic') ?>/images/thumbs/image2.png" alt="" /></div>
                                                    <div class="entry_content">
                                                  ...
                                                  <li>
                                                    <div class="entry_wrap">
                                                    <div class="entry_img"><img src="<?= Yii::getAlias('@basic') ?>/images/thumbs/image3.png" alt="" /></div>
                                                    <div class="entry_content">
                                                  ...
                                                  <li class="even">
                                                    <div class="entry_wrap">
                                                    <div class="entry_img"><img src="<?= Yii::getAlias('@basic') ?>/images/thumbs/image4.png" alt="" /></div>
                                                    <div class="entry_content">
                        ...
                        <div class="one_third last dashboard_right">
                            ...
                            <div class="widgetbox">
                                ...
                                <div class="widgetcontent userlistwidget nopadding">
                                    <ul>
                                        <li>
                                            <div class="avatar"><img alt="" src="<?= Yii::getAlias('@basic') ?>/images/thumbs/avatar1.png" /></div>
                                            <div class="info">
                                                <a href="">Squint</a> <br />
                                        ...
                                        <li>
                                            <div class="avatar"><img alt="" src="<?= Yii::getAlias('@basic') ?>/images/thumbs/avatar2.png" /></div>
                                            <div class="info">
                                                <a href="">Eunice</a> <br />
